  ...
  //  [SerializeField] private GameObject darkBox;
   ...
   RecruitmentManager recruitmentManager;
    ...
    private void Start()
    {
        ...
        // Initialize playerMovement here
    ...
    */
    private void Update()
    {
      ...
      (Input.GetKeyDown(KeyCode.Mouse0) || Input.GetKeyDown(KeyCode.E) || Input.GetKeyDown(KeyCode.Space)))
        {
            ContinueStory();
        }
    ...
    */
    ...
    private void DisplayChoices()
    {
        ...
        {
            if (index < choices.Length && choices[index] != null && choicesText[index] != null)
            {
